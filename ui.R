...
numericInput('comptonminspectra', label=h6("Min"), step=0.001, value=20, min=0, max=50, width='30%'),
numericInput('comptonmaxspectra', label=h6("Max"), step=0.001, value=22, min=0, max=50, width='30%'),
